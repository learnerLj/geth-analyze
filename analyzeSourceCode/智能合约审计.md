...
![image-20220201151421686](https://gitee.com/learnerLj/typora/raw/master/image-20220201151421686.png)

![image-20220201151807345](https://gitee.com/learnerLj/typora/raw/master/image-20220201151807345.png)

2. 复制 EtherStore 合约地址，作为构造函数参数，选择 Attack 合约，部署(注意去除部署时地址的双引号)!

![image-20220201152451682](https://gitee.com/learnerLj/typora/raw/master/image-20220201152451682.png)
...
Mythril 是 EVM 字节码的安全分析工具。它检测以太坊、Hedera、Quorum、Vechain、Roostock、Tron 和其他与 EVM 兼容的区块链构建的智能合约中的安全漏洞。它使用符号执行、SMT 解决和污点分析来检测各种安全漏洞。另外，他还有收费版本的 MythX。
...
![image-20220208162213888](https://gitee.com/learnerLj/typora/raw/master/image-20220208162213888.png)
...
![image-20220322113501266](https://gitee.com/learnerLj/typora/raw/master/img/image-20220322113501266.png)
